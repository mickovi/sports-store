...
const initializeOrderModels = (sequelize) => {
    order_models_1.OrderModel.init({ ...primaryKey, shipped: sequelize_1.DataTypes.BOOLEAN }, { sequelize });
    ...
    order_models_1.OrderModel.belongsTo(order_models_1.AddressModel, {
        foreignKey: "addressId",
        as: "address",
    });
    order_models_1.OrderModel.belongsToMany(order_models_1.ProductSelectionModel, {
